...
/**
 * This set of exercises is about lambdas and method references. You will write
 * a lambda or method reference corresponding to each of several different
 * functional interfaces. Each exercise is named after the functional interface
 * intended to be used as the solution.
 */
public class A_Lambdas {

	/**
	 * Write a lambda expression that is a predicate that tests whether a string is
	...
	/**
	 * Write an unbound method reference that is a predicate that tests whether a
	 * string is empty. An unbound method reference has a class name on the
	...
	/**
	 * Create a predicate that returns true if both predicates startsWithJ and
	 * lengthIs7 hold.
	 */
	@Test
	@Ignore
	...
	/**
	 * Create a predicate that is true if the length of the provided string is 9 or
	 * the provided string equals ERROR.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write an unbound method reference that converts the given string to upper
	 * case.
	 */
	@Test
	@Ignore
	...
	/**
	 * Given two Functions, one that converts a null reference to an empty string,
	 * and another that gets the length of a string, create a single function
	 * converts nulls and then gets the string's length.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that appends the string "abc" to the given
	 * StringBuilder.
	 */
	@Test
	@Ignore
	...
	/**
	 * Given two consumers, create a consumer that passes the String to the first
	 * consumer, then to the second.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that returns a new StringBuilder containing the
	 * string "abc".
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that, given two strings, returns the result of
	 * concatenating the first with the second, followed by the first again.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that returns the index of the first occurrence of
	 * the second string within the first string, or -1 if the second string doesn't
	 * occur within the first string.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write an unbound method reference that returns the index of the first
	 * occurrence of the second string within the first string, or -1 if the second
	 * string doesn't occur within the first string.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that appends the 'suffix' variable (a String) to
	...
	/**
	 * Write a lambda expression that takes a string argument and returns the index
	 * of that argument into the string "abcdefghij", or that returns -1 if the
	...
	/**
	 * Write a bound method reference that takes a string argument and returns the
	 * index of that argument into the string "abcdefghij", or that returns -1 if
	 * the string argument doesn't occur. A bound method reference has an instance,
	 * or an expression that evaluates to an instance, on the left-hand side of the
	 * :: operator:
	 *
	 * myObject::methodname
	 *
	 * This is in contrast to an unbound method reference, which has a classname on
